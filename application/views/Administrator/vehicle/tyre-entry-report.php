...
<div id="purchaseRecord">
    ...
    <div class="row" style="margin-top:15px;display:none;" v-bind:style="{display: tyre_details.length > 0 ? '' : 'none'}">
        ...
        <div class="col-xs-6 text-right" style="display:none;" v-bind:style="{display: searchType != 'vehicle' ? 'none' : ''}">
        ...
        <div class="col-xs-12">
            <div id="reportContent">
                <table class="table table-bordered" style="display:none" v-bind:style="{display: tyre_details.length > 0 ? '' : 'none'}" id="dataTable">
                    <thead>
                        <th>SL.</th>
                        <th>Tyre Name</th>
                        <th>Vehicle Name</th>
